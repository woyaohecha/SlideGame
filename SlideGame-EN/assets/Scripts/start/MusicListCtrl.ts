...
export class MusicList extends Component {
    ...
    setMusicInfoPanel() {
        ...
        TimePanel.string = "Duration：" + GameData.musicListConfig[GameData.currentMusicIndex].duration;
        targetPanel.string = "Slide Goals：" + GameData.musicListConfig[GameData.currentMusicIndex].slideGoals;
        costPanel.string = "Estimated Calories：" + GameData.musicListConfig[GameData.currentMusicIndex].EstimatedCalories;
        ...
        passPanel.string = "Game Conditions：" + GameData.musicListConfig[GameData.currentMusicIndex].gameConditions;
        this.indexLabel.string = "/ " + (GameData.currentMusicIndex + 1);
    }
