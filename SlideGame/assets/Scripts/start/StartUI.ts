...
import { _decorator, Component, Node, AudioClip, loader, Vec2, Vec3, instantiate, UIModelComponent, UITransformComponent, AudioSourceComponent, LabelComponent, director, Label, game, assetManager, ImageAsset, Sprite, SpriteFrame, Texture2D, AudioSource } from 'cc';
